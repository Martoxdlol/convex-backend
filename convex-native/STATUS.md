...
cargo test -p convex_native_integration_tests    # 131 tests
...
| `standalone_runner_knobs.rs` | monolith | `CountingMetrics` + `.total_latency()`, `begin_drain()`, `CircuitBreaker` open path **and** below-threshold closed path |
